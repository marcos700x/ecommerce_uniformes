...
from .models import Usuario, Pedido, Producto, Favoritos, DetallesPedido, HistorialStock, ClicksWhatsapp, Categoria, Color, Talla, ColorProducto, TallaVariante
...
class ProductoAdmin(admin.ModelAdmin):
    list_display = ('nombre', 'modelo', 'categoria')
